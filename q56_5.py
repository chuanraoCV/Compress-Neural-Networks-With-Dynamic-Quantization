...
def dynamic_quantizantion(v):
  ...
  mask4 = tf.where((v_abs>(3/4.0)*n4)&(v_abs <= (3/2.0)*n4), tf.ones(shape) * n4, mask3)
  mask5 = tf.where((v_abs > (3/2.0)*n6) & (v_abs <= (3/2.0)*n5), tf.ones(shape) * n5, mask4)
  mask6 = tf.where((v_abs > (3/2.0)*n7) & (v_abs <= (3/2.0)*n6), tf.ones(shape) * n6, mask5)
  mask7 = tf.where((v_abs > (3/2.0)*n8) & (v_abs <= (3/2.0)*n7), tf.ones(shape) * n7, mask6)
  mask8 = tf.where((v_abs > (3/2.0)*n9) & (v_abs <= (3/2.0)*n8), tf.ones(shape) * n8, mask7)
  mask9 = tf.where((v_abs > (3/2.0)*n10) & (v_abs <= (3/2.0)*n9), tf.ones(shape) * n9, mask8)
  mask10 = tf.where((v_abs > (3/2.0)*n11) & (v_abs <= (3/2.0)*n10), tf.ones(shape) * n10, mask9)
  mask11 = tf.where((v_abs > (3/2.0)*n12) & (v_abs <= (3/2.0)*n11), tf.ones(shape) * n11, mask10)
  mask12 = tf.where((v_abs > (3/2.0)*n13) & (v_abs <= (3/2.0)*n12), tf.ones(shape) * n12, mask11)
  mask13 = tf.where((v_abs > (3/2.0)*n14) & (v_abs <= (3/2.0)*n13), tf.ones(shape) * n13, mask12)
  mask14 = tf.where((v_abs > (3/2.0)*n15) & (v_abs <= (3/2.0)*n14), tf.ones(shape) * n14, mask13)
  mask15 = tf.where((v_abs > (3/2.0)*n16) & (v_abs <= (3/2.0)*n15), tf.ones(shape) * n15, mask14)
  mask16 = tf.where(v_abs <= (3/2.0)*n16, tf.ones(shape) * n16, mask15)
  with G.gradient_override_map({"Sign": "Identity"}):
    mask_result = tf.sign(v)*tf.stop_gradient(mask16)
...
saver.restore(sess,'./full_precision/res56/model/res.ckpt')
...
if not tf.gfile.Exists('q5_56model'):
    tf.gfile.MakeDirs('q5_56model')
saver.save(sess,'./q5_56model/res.ckpt')
