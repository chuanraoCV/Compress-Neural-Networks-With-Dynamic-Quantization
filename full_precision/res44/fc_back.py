...
tf.app.flags.DEFINE_string('train_tf_path', 'F:/raochuan_code/code/data/train.tf', '')
tf.app.flags.DEFINE_string('val_tf_path', 'F:/raochuan_code/code/data/test.tf', '')
...
saver.save(sess,'F:/raochuan_code/code/full_precision/res44/model/res.ckpt')