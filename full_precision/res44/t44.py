...
tf.app.flags.DEFINE_string('train_tf_path', 'F:/dynamicquantization/data/train.tf', '')
tf.app.flags.DEFINE_string('val_tf_path', 'F:/dynamicquantization/data/test.tf', '')
...
image_batch, label_batch = make_validation_batch(FLAGS.val_tf_path, FLAGS.val_batch_size)
...
saver.restore(sess,'F:/dynamicquantization/code/full_precision/res44/model1/res.ckpt')
